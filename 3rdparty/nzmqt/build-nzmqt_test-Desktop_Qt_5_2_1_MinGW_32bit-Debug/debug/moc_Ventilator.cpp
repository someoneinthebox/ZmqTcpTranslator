...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nzmqt__samples__pushpull__Ventilator_t, stringdata) + ofs \
...
void nzmqt::samples::pushpull::Ventilator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Ventilator *_t = static_cast<Ventilator *>(_o);
        switch (_id) {
        ...
        {
            typedef void (Ventilator::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ventilator::batchStarted)) {
                *result = 0;
            }
        }
        {
            typedef void (Ventilator::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ventilator::workItemSent)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject nzmqt::samples::pushpull::Ventilator::staticMetaObject = {
    { &SampleBase::staticMetaObject, qt_meta_stringdata_nzmqt__samples__pushpull__Ventilator.data,
      qt_meta_data_nzmqt__samples__pushpull__Ventilator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nzmqt__samples__pushpull__Ventilator.stringdata))
        return static_cast<void*>(const_cast< Ventilator*>(this));
