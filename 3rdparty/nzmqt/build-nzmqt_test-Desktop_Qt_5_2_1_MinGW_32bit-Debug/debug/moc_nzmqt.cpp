...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nzmqt__ZMQSocket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(13, 124, 10),
QT_MOC_LITERAL(14, 135, 8),
QT_MOC_LITERAL(15, 144, 8),
QT_MOC_LITERAL(16, 153, 8),
QT_MOC_LITERAL(17, 162, 5),
QT_MOC_LITERAL(18, 168, 10),
QT_MOC_LITERAL(19, 179, 11),
QT_MOC_LITERAL(20, 191, 11),
QT_MOC_LITERAL(21, 203, 6),
QT_MOC_LITERAL(22, 210, 8),
QT_MOC_LITERAL(23, 219, 8),
QT_MOC_LITERAL(24, 228, 11),
QT_MOC_LITERAL(25, 240, 9),
QT_MOC_LITERAL(26, 250, 11),
QT_MOC_LITERAL(27, 262, 11),
QT_MOC_LITERAL(28, 274, 12),
QT_MOC_LITERAL(29, 287, 6),
QT_MOC_LITERAL(30, 294, 8),
QT_MOC_LITERAL(31, 303, 11),
QT_MOC_LITERAL(32, 315, 6),
QT_MOC_LITERAL(33, 322, 10),
QT_MOC_LITERAL(34, 333, 13),
QT_MOC_LITERAL(35, 347, 15),
QT_MOC_LITERAL(36, 363, 12),
QT_MOC_LITERAL(37, 376, 12),
QT_MOC_LITERAL(38, 389, 8),
QT_MOC_LITERAL(39, 398, 16),
QT_MOC_LITERAL(40, 415, 10),
QT_MOC_LITERAL(41, 426, 10),
QT_MOC_LITERAL(42, 437, 10),
QT_MOC_LITERAL(43, 448, 17),
QT_MOC_LITERAL(44, 466, 21),
QT_MOC_LITERAL(45, 488, 11)
    },
    "nzmqt::ZMQSocket\0messageReceived\0\0"
    "QList<QByteArray>\0close\0Type\0TYP_PUB\0"
    "TYP_SUB\0TYP_PUSH\0TYP_PULL\0TYP_REQ\0"
    "TYP_REP\0TYP_DEALER\0TYP_ROUTER\0TYP_PAIR\0"
    "TYP_XPUB\0TYP_XSUB\0Event\0EVT_POLLIN\0"
    "EVT_POLLOUT\0EVT_POLLERR\0Events\0SendFlag\0"
    "SND_MORE\0SND_NOBLOCK\0SendFlags\0"
    "ReceiveFlag\0RCV_NOBLOCK\0ReceiveFlags\0"
    "Option\0OPT_TYPE\0OPT_RCVMORE\0OPT_FD\0"
    "OPT_EVENTS\0OPT_SUBSCRIBE\0OPT_UNSUBSCRIBE\0"
...
static const uint qt_meta_data_nzmqt__ZMQSocket[] = {
 ...
 // enum data: key, value
       6, uint(nzmqt::ZMQSocket::TYP_PUB),
       7, uint(nzmqt::ZMQSocket::TYP_SUB),
       8, uint(nzmqt::ZMQSocket::TYP_PUSH),
       9, uint(nzmqt::ZMQSocket::TYP_PULL),
      10, uint(nzmqt::ZMQSocket::TYP_REQ),
      11, uint(nzmqt::ZMQSocket::TYP_REP),
      12, uint(nzmqt::ZMQSocket::TYP_DEALER),
      13, uint(nzmqt::ZMQSocket::TYP_ROUTER),
      14, uint(nzmqt::ZMQSocket::TYP_PAIR),
      15, uint(nzmqt::ZMQSocket::TYP_XPUB),
      16, uint(nzmqt::ZMQSocket::TYP_XSUB),
      18, uint(nzmqt::ZMQSocket::EVT_POLLIN),
      19, uint(nzmqt::ZMQSocket::EVT_POLLOUT),
      20, uint(nzmqt::ZMQSocket::EVT_POLLERR),
      18, uint(nzmqt::ZMQSocket::EVT_POLLIN),
      19, uint(nzmqt::ZMQSocket::EVT_POLLOUT),
      20, uint(nzmqt::ZMQSocket::EVT_POLLERR),
      23, uint(nzmqt::ZMQSocket::SND_MORE),
      24, uint(nzmqt::ZMQSocket::SND_NOBLOCK),
      23, uint(nzmqt::ZMQSocket::SND_MORE),
      24, uint(nzmqt::ZMQSocket::SND_NOBLOCK),
      27, uint(nzmqt::ZMQSocket::RCV_NOBLOCK),
      27, uint(nzmqt::ZMQSocket::RCV_NOBLOCK),
      30, uint(nzmqt::ZMQSocket::OPT_TYPE),
      31, uint(nzmqt::ZMQSocket::OPT_RCVMORE),
      32, uint(nzmqt::ZMQSocket::OPT_FD),
      33, uint(nzmqt::ZMQSocket::OPT_EVENTS),
      34, uint(nzmqt::ZMQSocket::OPT_SUBSCRIBE),
      35, uint(nzmqt::ZMQSocket::OPT_UNSUBSCRIBE),
      36, uint(nzmqt::ZMQSocket::OPT_AFFINITY),
      37, uint(nzmqt::ZMQSocket::OPT_IDENTITY),
      38, uint(nzmqt::ZMQSocket::OPT_RATE),
      39, uint(nzmqt::ZMQSocket::OPT_RECOVERY_IVL),
      40, uint(nzmqt::ZMQSocket::OPT_SNDBUF),
      41, uint(nzmqt::ZMQSocket::OPT_RCVBUF),
      42, uint(nzmqt::ZMQSocket::OPT_LINGER),
      43, uint(nzmqt::ZMQSocket::OPT_RECONNECT_IVL),
      44, uint(nzmqt::ZMQSocket::OPT_RECONNECT_IVL_MAX),
      45, uint(nzmqt::ZMQSocket::OPT_BACKLOG),
...
const QMetaObject nzmqt::ZMQSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nzmqt__ZMQSocket.data,
      qt_meta_data_nzmqt__ZMQSocket,  qt_static_metacall, 0, 0}
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_nzmqt__ZMQContext_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject nzmqt::ZMQContext::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nzmqt__ZMQContext.data,
      qt_meta_data_nzmqt__ZMQContext,  qt_static_metacall, 0, 0}
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_nzmqt__PollingZMQSocket_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject nzmqt::PollingZMQSocket::staticMetaObject = {
    { &ZMQSocket::staticMetaObject, qt_meta_stringdata_nzmqt__PollingZMQSocket.data,
      qt_meta_data_nzmqt__PollingZMQSocket,  qt_static_metacall, 0, 0}
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_nzmqt__PollingZMQContext_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(7, 63, 8)
    ...
    "errorNum\0errorMsg\0run\0poll\0timeout_\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject nzmqt::PollingZMQContext::staticMetaObject = {
    { &ZMQContext::staticMetaObject, qt_meta_stringdata_nzmqt__PollingZMQContext.data,
      qt_meta_data_nzmqt__PollingZMQContext,  qt_static_metacall, 0, 0}
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_nzmqt__SocketNotifierZMQSocket_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
QT_MOC_LITERAL(1, 31, 18),
QT_MOC_LITERAL(2, 50, 0)
    },
    "nzmqt::SocketNotifierZMQSocket\0"
    "socketReadActivity\0\0"
};
#undef QT_MOC_LITERAL
...
const QMetaObject nzmqt::SocketNotifierZMQSocket::staticMetaObject = {
    { &ZMQSocket::staticMetaObject, qt_meta_stringdata_nzmqt__SocketNotifierZMQSocket.data,
      qt_meta_data_nzmqt__SocketNotifierZMQSocket,  qt_static_metacall, 0, 0}
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_nzmqt__SocketNotifierZMQContext_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject nzmqt::SocketNotifierZMQContext::staticMetaObject = {
    { &ZMQContext::staticMetaObject, qt_meta_stringdata_nzmqt__SocketNotifierZMQContext.data,
      qt_meta_data_nzmqt__SocketNotifierZMQContext,  qt_static_metacall, 0, 0}
};
